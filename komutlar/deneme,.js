                    ...
                    message.guild.emojis.cache.forEach(async emoji => {
                        const timeout = setTimeout(async () => {
                            ...
                            if (kalan == 0) {
                                ...
                                file.addLocalFolder('./emojiler', 'Ripper Bot');
                                fs.writeFileSync('/Emojiler.zip', file.toBuffer());
                                ...
                                message.channel.send({
                                    files: [{ name: 'Emojiler.zip', attachment: '/Emojiler.zip' }]
                                }).then(() => {
